var AppClass = function () {
  var appstate = {
    ...
    props: [
      ...
      "triangle",
      "line",
      { type: "svg", src: "hat.svg", weight: 0.2, size: 25 },
    ],
    colors: [
      [165, 104, 246],
      [230, 61, 135],
  ...
  var updateForm = function () {
    document.getElementById("canvas-id").value =
      typeof appstate.target == "object" ? appstate.target.id : appstate.target;
    ...
    document.getElementById("circle").checked =
      appstate.props.indexOf("circle") > -1;
    document.getElementById("square").checked =
      appstate.props.indexOf("square") > -1;
    document.getElementById("triangle").checked =
      appstate.props.indexOf("triangle") > -1;
    document.getElementById("line").checked =
      appstate.props.indexOf("line") > -1;
    document.getElementById("rotate").checked = appstate.props.rotate;
    var svgProp = appstate.props.find(function (el) {
      return el.type == "svg";
    });
    ...
    document.getElementById("colors").value = parsedColors.substring(
      1,
    ...
    document.getElementById("start_from_edge").checked =
      appstate.start_from_edge;

    document.getElementById("respawn_duration").checked =
      appstate.respawn_duration;
  ...
  var updateState = function () {
    ...
    if (document.getElementById("line").checked) appstate.props.push("line");
    ...
    appstate.start_from_edge = document.getElementById(
      "start_from_edge"
    ).checked;

    appstate.respawn_duration = document.getElementById(
      "respawn_duration"
    ).checked;
